 ...
 */
import { AuthType, TerminalQuotaError, ModelNotFoundError, PREVIEW_GEMINI_MODEL, DEFAULT_GEMINI_MODEL, } from '@google/gemini-cli-core';
    ...
    const handleProQuotaChoice = useCallback((choice) => {
        ...
        if (choice === 'retry_always') {
            ...
            if (proQuotaRequest.failedModel === PREVIEW_GEMINI_MODEL) {
                const showPeriodicalCheckMessage = !proQuotaRequest.isModelNotFoundError &&
