...
describe('useLoadingIndicator', () => {
    ...
    const renderLoadingIndicatorHook = (initialStreamingState, initialIsInteractiveShellWaiting = false, initialLastOutputTime = 0) => {
        let hookResult;
        function TestComponent({ streamingState, isInteractiveShellWaiting, lastOutputTime, }) {
            hookResult = useLoadingIndicator(streamingState, undefined, isInteractiveShellWaiting, lastOutputTime);
            return null;
        }
        const { rerender } = render(_jsx(TestComponent, { streamingState: initialStreamingState, isInteractiveShellWaiting: initialIsInteractiveShellWaiting, lastOutputTime: initialLastOutputTime }));
        return {
            result: {
                get current() {
                    return hookResult;
