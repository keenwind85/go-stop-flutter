      ...
      child: Column(
        ...
        children: [
          ...
          _buildStepCard(
            step: 1,
            title: '방 만들기',
            description: '"새 게임 만들기" 버튼을 터치 → 상대방 입장 대기',
          ),
          _buildStepCard(
            step: 2,
            title: '방 참가하기',
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildSectionTitle('광끼 모드'),
          _buildInfoCard(
            icon: '🔥',
            title: 'Winner Takes All!',
            description: '광끼 게이지 100 도달 시 발동 가능\n양 플레이어 동의 시 활성화\n→ 승자가 모든 베팅 코인을 가져감!',
            color: Colors.deepOrange,
          ),
        ],
      ),
